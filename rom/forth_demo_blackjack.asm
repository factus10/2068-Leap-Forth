...
; ============================================================================
    ...
    IFDEF CARTRIDGE
; ---- DOCK cartridge build (make forth-demo-blackjack-cart): the 5-byte LROS header
...
SRC_VERIFY_LEN EQU $ - SRC_VERIFY
    ...
    IFDEF CARTRIDGE
    SAVEBIN "forth_demo_blackjack_cart.bin", $0000, $4000   ; raw LROS image; tools/make_dck.py wraps it as .dck
    ELSE
